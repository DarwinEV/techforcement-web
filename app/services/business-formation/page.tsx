...
export const metadata: Metadata = {
  title: 'Business Formation | Techforcement',
  description: 'LLC registration and EIN acquisition to get your business started right. Professional business formation services.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <div className="text-center mb-16">
          ...
          <p className="text-xl leading-8 text-gray-600 max-w-3xl mx-auto">
            LLC registration and EIN acquisition to get your business started right. We handle the paperwork so you can focus on growing your business.
          </p>
        </div>
        ...
        <div className="text-center bg-gray-900/10 backdrop-blur-sm border border-gray-200/30 rounded-2xl p-12">
          ...
          <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
            Let us handle the legal paperwork and business formation process for you.
          </p>
